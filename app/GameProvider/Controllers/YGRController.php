...
class YGRController
{
    ...
    private function productionSlotGames(): array
    {
        return [
            ['101', "Loong Fa Le", '97'],
            ['100', "Captain Whale", '97'],
            ['099', "Magic Treasure", '97'],
            ['098', "Dinosaur Egg 2", '97'],
            ['097', "Maya Golden City6", '97'],
            ['096', "GOLDEN PHARAOH", '97'],
            ['095', "Cash Maker 2", '97'],
            ['094', "GOLDEN KINGDOM", '97'],
    ...
    private function productionFishGames(): array
    {
        return [
            ['070', "Make a Killing Fishing", '97'],
            ['068', "Fortune Fishing", '97'],
    ...
    private function productionArcadeGames(): array
    {
        return [
            ['047', "Pinball Fun", '97'],
            ['046', "Scratch & Win", '0'],
